...
class RiskClassificationHook(LifecycleHook):
    ...
    _MEDIUM_RISK_ACTIONS: Set[Tuple[str, str]] = {
        ...
        ("timeline", "copy_range"),
        # Builds nested Fusion title timelines and places their clips on a
        # destination video track. Additive on success, with explicit rollback
        # for partially-created sources and placements.
        ("edit_engine", "create_animated_captions"),
